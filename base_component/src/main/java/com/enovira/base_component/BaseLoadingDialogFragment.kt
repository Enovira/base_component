...
import com.enovira.base_component.dialog.LoadingBaseDialogBuilder
 ...
 * @description
 */
abstract class BaseLoadingDialogFragment(private val builder: LoadingBaseDialogBuilder) : DialogFragment() {
    ...
    open fun setLayout(dialogInstance: Dialog) {
        resources.displayMetrics.let {
            dialogInstance.window?.setLayout(resources.displayMetrics.widthPixels, resources.displayMetrics.heightPixels)
        }
    }
}